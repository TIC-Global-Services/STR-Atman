    ...
    <section className="relative w-full bg-transparent flex items-center justify-center py-20">
      <div className="relative w-[95%] h-[50dvh] md:h-[90dvh] rounded-2xl" >
        ...
        <Image
          ...
          fill
          className="object-cover object-[70%_50%] md:object-[50%_10%] rounded-2xl"
          priority
          quality={100}
        />
        <div className=' absolute inset-0 bg-linear-to-r from-black via-black/50  to-transparent rounded-2xl' />
        {/* Text Content Overlay */}
        <div className="absolute inset-0 flex items-end mditems-center py-6">
          <div className=" px-6 md:px-12 lg:px-16 space-y-4 md:space-y-8 max-w-2xl">
            <h2 
            ...
            <p className="text-white/90 text-16px lg:text-xl leading-tight">
