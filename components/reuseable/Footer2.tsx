...
const Footer = () => {
  ...
  return (
    <div className="px-4 sm:px-8 mx-auto w-full bg-[#000] pt-16 sm:pt-20 pb-6 md:pb-0">
      ...
      {/* ================= COPYRIGHT ================= */}
      <div className="absolute z-50 flex flex-col sm:flex-row gap-2  md:w-[75%] items-end md:items-center justify-between bottom-4 md:bottom-[2%] right-2 md:right-6 text-[clamp(0.75rem,0.4rem+0.4vw,0.95rem)] text-[#FDFDFD] px-4 ">
